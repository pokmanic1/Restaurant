    ...
    <section className='col-center principal-gradient w-full min-w-[375px] min-h-[95dvh] px-[5px] py-[50px]'>
      ...
      <div className='w-[80%] max-w-[1200px] gap-10 grid grid-cols-1 md:grid-cols-2 items-center'>
        ...
        <div className="p-6 grid grid-cols-1 gap-5">
          ...
          <div className="group rounded-xl border border-white/10 bg-white/5 backdrop-blur-md p-6 text-white transition-all duration-300 hover:border-white/20 hover:bg-white/10 hover:shadow-lg">
